...
import React, { useState } from 'react';
// Assuming Header is now at this path
import Header from './components/shared/Header'; 
import Footer from './components/shared/Footer';
import AddLabForm from './components/forms/AddLabForm';
import AddTestForm from './components/forms/AddTestForm';
...
// Import the Page type from the new shared location (Adjust path as needed)
import type { Page } from './type'; 


const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL!;

// Removed the type definition as it's now in a shared file:
// type Page = 'home' | 'manageLabs' | 'addTest' | 'addLab' | 'generateBill' | 'viewBills';
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="flex justify-center">
                <Button
                  ...
                  onClick={() => setCurrentPage('viewBills')}
                >
                  📄 View Bills
                </Button>
              </CardContent>
